class zcl_360_carga_biblio_lgl definition
  public
  final
  create public .
...
class zcl_360_carga_biblio_lgl implementation.

  method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_acc_categ_l,
          lt_catego    type table of ztb_categ_lgl,
...
******** ztb_categ_lgl ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_categ_lgl.
    insert ztb_categ_lgl from table @lt_catego.
